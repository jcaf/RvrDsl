...
Actualizado para trabaajar en modo PORT con AVR/PIC
*/
#include <avr/io.h>
#include <stdint.h>
#include "../system.h"
...
#define PORTRxLCDAN PIND
#define CONFIGIOxLCDAN DDRD
...
void lcdan_set_controlpins_and_datapins_outputs(void)
{
		...
		//CONFIGIOxLCDAN &= 0x01;
	ConfigOutputPort(CONFIGIOxLCDAN, 0B11111110);
	#elif  LCDAN_MODE==LCDAN_BIT
...
void lcdan_set_datapins_inputs(void)
{
	...
	ConfigInputPort(CONFIGIOxLCDAN, 0B11110000);
